...
Здесь я собрал готовые, принятые работы проектов курса с комментариями ревьюеров.
Эти учебные проекты, на мой взгляд, будут интересны новичкам в Data Science а не потенциальным заказчикам, поэтому я оставил комментарии ревьюеров.

Некоторые из комментариев оказались полезными и развивающими, некоторые воспринимались как придирки и "чтобы было". По каждому проекту я описал исправления и улучшения после правок ревьюера.
Датасеты нас попросили не публиковать, поэтому я оставил только блоки загрузки данных.
...
## Проект: Компьютерное зрение. Определение возраста покупателей сетевого супермаркета «Хлеб-Соль»
### Что получилось сделать хорошо:
- проект получилось сдать с первого раза
- метрика MAE на тестовой выборке получилась 5.062, что очень хорошо

[Ноутбук](faces.ipynb)

## Выпускной проект: Предсказание температуры стали на комбинате "Стальная птица"
### Что получилось сделать хорошо:
- проект получилось сдать со второго раза
- правки в основном касались выводов
- получилось самостоятельно улучшить выходную метрику

[Ноутбук](production_final.ipynb)
